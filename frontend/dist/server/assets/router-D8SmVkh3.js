...
import { z } from "zod";
const appCss = "/assets/styles-TMeD0Fr-.css";
const dict = {
  ru: {
    // Nav
    "nav.pricing": "Тарифы",
...
function NotFoundComponent() {
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative flex min-h-screen flex-col items-center justify-center px-4 text-center", children: [
      /* @__PURE__ */ jsx("p", { className: "text-[10rem] font-black leading-none tracking-tighter text-foreground/10 select-none", children: "404" }),
      /* @__PURE__ */ jsx("h1", { className: "mt-2 text-2xl font-black tracking-tight", children: "Страница не найдена" }),
      /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Такой страницы нет — возможно, ссылка устарела или вы ошиблись адресом." }),
      /* @__PURE__ */ jsx(
        Link,
        {
          to: "/",
...
const $$splitComponentImporter$b = () => import("./terms-DqJegEAd.js");
...
const $$splitComponentImporter$a = () => import("./success-Bq2U3Reh.js");
const Route$a = createFileRoute("/success")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$9 = () => import("./privacy-D4dziYpq.js");
...
const $$splitComponentImporter$8 = () => import("./checkout-DNEHSD3W.js");
...
async function getDevicesForUser() {
  ...
  const devices = (resp.devices || []).map((d) => ({
    id: d.hwid ?? d.id,
    name: d.name ?? d.hwid ?? "Unknown",
    platform: (d.platform ?? "unknown").toLowerCase(),
    created_at: d.createdAt ?? d.created_at ?? (/* @__PURE__ */ new Date()).toISOString(),
...
const $$splitComponentImporter$7 = () => import("./auth-BIByrw9D.js");
const Route$7 = createFileRoute("/auth")({
  ssr: false,
  beforeLoad: async () => {
    const result = await getUserSession().catch(() => null);
    if (result?.id) throw redirect({
      to: "/dashboard"
    });
  },
  head: () => ({
...
const $$splitComponentImporter$6 = () => import("./route-BKrcK3WN.js");
...
const $$splitComponentImporter$5 = () => import("./index-Dbi4TU_i.js");
const Route$5 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "One key for all devices. Simple setup, high speed, unlimited traffic."
    }, {
      property: "og:title",
      content: "ClickVPN — Fast & Unlimited VPN"
    }, {
...
const $$splitComponentImporter$4 = () => import("./settings-D-jS3Bz8.js");
const Route$4 = createFileRoute("/_authenticated/settings")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$3 = () => import("./payments-DWBEp3RL.js");
const Route$3 = createFileRoute("/_authenticated/payments")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$2 = () => import("./devices-cyQQFyvh.js");
const Route$2 = createFileRoute("/_authenticated/devices")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$1 = () => import("./dashboard-B6vyLf-V.js");
...
const $$splitComponentImporter = () => import("./connect-ZkV01D8v.js");
...
const SuccessRoute = Route$a.update({
  id: "/success",
  path: "/success",
  getParentRoute: () => Route$c
});
...
const AuthenticatedSettingsRoute = Route$4.update({
  id: "/settings",
  path: "/settings",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedPaymentsRoute = Route$3.update({
  id: "/payments",
  path: "/payments",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedDevicesRoute = Route$2.update({
  id: "/devices",
  path: "/devices",
  getParentRoute: () => AuthenticatedRouteRoute
});
...
const AuthenticatedConnectRoute = Route.update({
  id: "/connect",
  path: "/connect",
  getParentRoute: () => AuthenticatedRouteRoute
});
